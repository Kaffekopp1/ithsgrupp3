...
exports.getActorWithmovie = async (req, res) => {
  ...
  let sql =
    "select movieName, movieYear, movieId, personName, personBorn, personImg from movie join movieJobPerson mJP on movie.movieId = mJP.movieJobPersonMID join  person p on p.personId = mJP.movieJobPersonPID where movieJobPersonPID = ? ";
  try {
